...
import './SinglePost.model.css';
import RelatedPosts from '../components/RelatedPosts';

const SinglePost = () => {
  const {post_id} = useParams();
  const {getPost, error, loading} = usePostContext();
      ...
      <main className="pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div className="flex justify-between px-4 mx-auto max-w-screen-xl ">
          <article className="mx-auto w-full max-w-2xl format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
            ...
            <div id="single-blog-post-style-only">
              <div
            ...
            <section className="not-format">
              ...
              <form className="mb-6">
                <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                  <label
                    htmlFor="comment"
                    className="sr-only dark:text-gray-400"
                  >
                    Your comment
                  </label>
                  <textarea
              ...
              <article className="p-6 mb-6 ml-6 lg:ml-12 text-base bg-white rounded-lg dark:bg-gray-900">
                ...
                <p className="dark:text-gray-400">Much appreciated! Glad you liked it ☺️</p>
                <div className="flex items-center mt-4 space-x-4">
                  <button
                    type="button"
                    className="flex items-center font-medium text-sm text-gray-500 hover:underline dark:text-gray-400"
